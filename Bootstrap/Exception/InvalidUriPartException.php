 ...
 **/
class InvalidUriPartException extends \Exception {
	...
	public function __construct( $message = "Internal Server Error (InvalidUriPartException)", $code = 500, \Exception $previous = null ) {
